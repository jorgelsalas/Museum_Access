...
public class AudioActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        //Toast.makeText(this, "Entro a audio", Toast.LENGTH_LONG).show();
    ...
    private void poblarAudio(int id_articulo){
    	String url = getString(R.string.url_servidor);
    	url += getString(R.string.nombre_php_obtener_audio);
 		    ...
 		    while ((line = in.readLine()) != null) {
 		    	...
 		    	//En caso de que no se recuperen elementos se indica esto al usuario
 	 		    if (line.equalsIgnoreCase("null")){
 	 		    	/*Se agregan un row*/
 	            	TableLayout tl = (TableLayout) findViewById(R.id.tabla_sonidos);
 		            ...
 		            aviso.setText(getResources().getString(R.string.advertencia_no_hay_audio));
		        ...
		        for (int i = 0; i < ja.length(); i++) {
		            ...
		            id = Integer.parseInt(jo.getString("id_audio"));
	                ...
	                tv_descripcion.setOnClickListener(new View.OnClickListener() {
	        			public void onClick(View v) {
	        				reproducirAudio(identificador, extension);
	        			}
	        		});
		        }
		    }
    ...
    private void reproducirAudio(int idAudio, String extension){
		
	    String url = getString(R.string.url_servidor) + getString(R.string.carpeta_audio) + "/" + idAudio + "." + extension;
   		Intent reproducirAudio = new Intent(this, Reproduccion_A_V_Activity.class);
	    reproducirAudio.putExtra("URL_Multimedia", url);
	    reproducirAudio.putExtra("esVideo", false);
   		startActivity(reproducirAudio);	
